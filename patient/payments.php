                                ...
                                <div class="row no-gutters align-items-center">
                                    <div class="col mr-2">
                                        <div class="text-xs fw-bold text-primary text-uppercase mb-1">
                                            Total Due</div>
                                        <div class="h5 mb-0 fw-bold text-gray-800">$<?php echo number_format($total_due, 2); ?></div>
                                    </div>
                                    <div class="col-auto">
                                ...
                                <div class="row no-gutters align-items-center">
                                    <div class="col mr-2">
                                        <div class="text-xs fw-bold text-success text-uppercase mb-1">
                                            Paid This Month</div>
                                        <div class="h5 mb-0 fw-bold text-gray-800">$<?php echo number_format($total_paid_this_month, 2); ?></div>
                                    </div>
                                    <div class="col-auto">
                                ...
                                <div class="row no-gutters align-items-center">
                                    <div class="col mr-2">
                                        <div class="text-xs fw-bold text-info text-uppercase mb-1">
                                            Payment Methods</div>
                                        <div class="h5 mb-0 fw-bold text-gray-800"><?php echo count($payment_methods); ?></div>
                                    </div>
                                    <div class="col-auto">
                            ...
                            <div class="card-body">
                                <div class="row no-gutters align-items-center">
                                    <div class="col mr-2">
                                        ...
                                        <div class="h5 mb-0 fw-bold text-gray-800">80%</div>
                                    </div>
                                    <div class="col-auto">
