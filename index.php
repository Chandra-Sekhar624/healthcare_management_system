...
<head>
    ...
    <title>HealthTech | Premium Online Health System</title>
    <!-- Bootstrap 5.1.3 CSS -->
...
<body>
        ...
        <div class="container">
            <div class="row text-center mb-5">
                <div class="col-lg-8 mx-auto">
                    <h2 class="section-title">Why Choose HealthTech?</h2>
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6 mb-4 mb-lg-0">
                    <img src="img/about-image.svg" alt="About HealthTech" class="img-fluid rounded">
                </div>
                <div class="col-lg-6">
                    <h2 class="section-title">About HealthTech</h2>
                    <p class="mb-4">HealthTech is a state-of-the-art online health system platform designed to transform the healthcare experience by connecting doctors and patients seamlessly in the digital space.</p>
        ...
        <div class="container">
            <div class="row text-center mb-5">
                <div class="col-lg-8 mx-auto">
                    ...
                    <p class="section-subtitle">Meet our team of experienced healthtech professionals</p>
                </div>
            </div>
            <div class="row g-4">
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="testimonial-card h-100">
                        <div class="testimonial-content">
                            ...
                            <p class="testimonial-text">"HealthTech has completely transformed how I manage my healthcare. The appointment scheduling is seamless, and I love having all my medical records in one place."</p>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="testimonial-card h-100">
                        <div class="testimonial-content">
                            ...
                            <p class="testimonial-text">"As a doctor, I appreciate how HealthTech streamlines my practice. The appointment management system is intuitive, and it helps me provide better care to my patients."</p>
                            <div class="testimonial-author d-flex align-items-center mt-4">
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="testimonial-card h-100">
                        <div class="testimonial-content">
                            ...
                            <p class="testimonial-text">"Finding the right specialist used to be challenging, but with HealthTech, I was able to browse doctors' profiles and book an appointment within minutes. The platform is user-friendly and efficient."</p>
                            <div class="testimonial-author d-flex align-items-center mt-4">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="email" id="email" name="e1" class="form-control" required>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-group">
                ...
                <div class="col-lg-4">
                    <div class="footer-info">
                        <a href="index.php" class="footer-logo d-flex align-items-center mb-3">
                            <i class="fas fa-heartbeat text-primary me-2"></i>
                            <span class="fw-bold fs-4">HealthTech</span>
                        </a>
    ...
    </a>    <!-- Bootstrap 5.1.3 JS with Popper -->
